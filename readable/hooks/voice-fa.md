---
name: sade-benevis
description: فارسی را ساده، کوتاه و مرتب بنویس؛ نه ترجمه‌زده، نه اداری، نه پرحرف. برای هر پاسخ فارسی همیشه اعمال شود. Persian anti-slop, plain and concise Persian.
---

# ساده‌بنویس

فارسیِ خشک، ترجمه‌زده و پرحرف را به فارسیِ ساده و مرتب برگردان. روی هر جواب فارسی.
