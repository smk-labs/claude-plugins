...
name: go
description: >
  وضعیت فوق‌خلاصه + ادامهٔ خودکار کار ناتمام. وقتی سشن وسط کار قطع شده یا کاربر می‌گوید «ادامه», «ادامه بده», «وضعیت چیه», «چه خبر», «go», «/go», or wants to resume after a disconnect: سه سطر وضعیت بده و بلافاصله از همان نقطه ادامه بده. Never restart from scratch.
---
