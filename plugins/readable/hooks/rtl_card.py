...
STYLE = (
    "<style>@import url('https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;700&display=swap"
    "');#rtl-card{direction:rtl;text-align:start;font-family:Vazirmatn,-apple-system,'Segoe UI',Tahoma,sa"
    "ns-serif;font-size:16px;line-height:1.9;color:var(--text-primary);background:var(--surface-1);border"
    ":0.5px solid var(--border);border-radius:12px;padding:1.25rem 1.5rem;margin:.5rem 0}#rtl-card>:first"
    "-child{margin-top:0}#rtl-card>:last-child{margin-bottom:0}#rtl-card p,#rtl-card li,#rtl-card h1,#rtl"
    "-card h2,#rtl-card h3,#rtl-card h4,#rtl-card td,#rtl-card th,#rtl-card blockquote{unicode-bidi:plain"
    "text}#rtl-card h1{font-size:22px;font-weight:700;margin:1.4rem 0 .7rem}#rtl-card h2{font-size:18px;f"
    "ont-weight:700;margin:1.2rem 0 .6rem}#rtl-card h3,#rtl-card h4{font-size:16px;font-weight:700;margin"
    ":1rem 0 .5rem}#rtl-card p{margin:.65rem 0}#rtl-card strong{font-weight:700}#rtl-card code{direction:"
    "ltr;unicode-bidi:isolate;font-family:var(--font-mono);font-size:13.5px;background:var(--surface-2);b"
    "order:0.5px solid var(--border);border-radius:5px;padding:2px 6px}#rtl-card pre{direction:ltr;unicod"
    "e-bidi:isolate;text-align:left;background:var(--surface-2);border:0.5px solid var(--border);border-r"
    "adius:8px;padding:12px 16px;overflow-x:auto;line-height:1.7}#rtl-card pre code{background:none;borde"
    "r:none;padding:0;font-size:13.5px}#rtl-card a{color:var(--text-accent);text-decoration:none;border-b"
    "ottom:1px solid var(--border-strong)}#rtl-card a.u{direction:ltr;unicode-bidi:isolate;word-break:bre"
    "ak-all}#rtl-card ul,#rtl-card ol{margin:.65rem 0;padding-inline-start:1.5rem}#rtl-card li{margin:.35"
    "rem 0}#rtl-card blockquote{margin:1rem 0;padding:.3rem 1.1rem;border-inline-start:3px solid var(--bo"
    "rder-strong);border-radius:0;color:var(--text-secondary)}#rtl-card table{border-collapse:collapse;ma"
    "rgin:1rem 0;width:100%;font-size:15px}#rtl-card th{font-weight:700;text-align:start;color:var(--text"
    "-secondary);font-size:14px}#rtl-card th,#rtl-card td{border:none;border-bottom:0.5px solid var(--bor"
    "der);padding:8px 12px}#rtl-card tbody tr:last-child td{border-bottom:none}#rtl-card hr{border:none;b"
    "order-top:0.5px solid var(--border);margin:1.4rem 0}#rtl-card svg{max-width:100%;height:auto;display"
    ":block;margin:1rem auto}</style>"
)
